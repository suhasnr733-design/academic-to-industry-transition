  ...
  return (
    <div className="w-full max-w-lg mx-auto bg-[#111827] backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-2xl border border-gray-800/90 transition-all">
      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          ...
          <div className="sm:col-span-2">
            <Input
              label="Faculty Email"
              type="email"
              placeholder="e.g. professor@college.edu or faculty@university.edu"
              {...register('email')}
        ...
        <Button
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold rounded-xl shadow-lg shadow-purple-500/25 active:scale-[0.99] transition-all mt-2"
          isLoading={isLoading}
        >
        ...
        <p className="text-center text-xs text-gray-400 pt-1">
          Already registered?{' '}
          <Link to="/faculty/login" className="text-purple-400 hover:text-purple-300 font-bold hover:underline">
            Faculty Sign In
          </Link>
        </p>
      </form>
