        ...
        <div className="space-y-4 text-center">
          <div className="p-6 bg-green-50 text-green-800 rounded-xl text-sm border border-green-200 space-y-3">
            ...
            <p className="text-xs text-green-700 leading-relaxed">
              A password reset link has been dispatched to <strong>{submittedEmail}</strong>. Please check your inbox or spam folder to set a new password. The link is valid for <strong>10 minutes</strong>.
            </p>
          </div>
          <div className="pt-2">
            <Link 
