  ...
  return (
    <div className="w-full max-w-lg mx-auto bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl p-5 sm:p-7 rounded-2xl shadow-xl shadow-blue-100/50 dark:shadow-none border-t-4 border-t-blue-600 border-x border-b border-slate-200/70 dark:border-gray-700/80 transition-all">
      ...
      <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
        ...
        <Button
          type="submit"
          className="w-full py-2.5 bg-gradient-to-r from-primary-600 to-indigo-600 hover:from-primary-700 hover:to-indigo-700 text-white font-medium shadow-md shadow-primary-500/25 active:scale-[0.99] transition-all mt-1"
          isLoading={isLoading}
        >
          Create Student Account
        </Button>
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-400 pt-1">
          ...
          <Link to="/login" className="text-primary-600 hover:text-primary-700 dark:text-primary-400 font-semibold hover:underline">
            Sign in
          </Link>
        </p>
      </form>
