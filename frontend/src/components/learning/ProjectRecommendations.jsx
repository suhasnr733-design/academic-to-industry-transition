...
export const ProjectRecommendations = ({ project, skillName, onBookmark }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-900 to-slate-900 text-white rounded-2xl p-6 shadow-md relative overflow-hidden">
      ...
      <div className="flex items-center justify-between pt-2 border-t border-indigo-700/40">
        <button
          onClick={() => alert(`Starting ${project.title}! Follow the learnings guide to build this project.`)}
          className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold text-xs rounded-xl shadow transition-all"
        >
          Start Mini-Project
