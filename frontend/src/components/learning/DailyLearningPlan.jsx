...
export const DailyLearningPlan = ({ dailyPlan, onStartLesson }) => {
  if (!dailyPlan) return null

  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-indigo-100 rounded-2xl p-5 shadow-sm mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500 font-medium flex items-center gap-1">
              ...
              {dailyPlan.estimated_minutes} mins
            </span>
          </div>
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-xl shadow transition-all hover:shadow-md whitespace-nowrap self-start sm:self-center"
      >
