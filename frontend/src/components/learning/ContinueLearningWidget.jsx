...
export const ContinueLearningWidget = ({ continueData, onContinue }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <button
        onClick={onContinue}
        className="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl shadow transition-colors"
      >
